...
**本次更新：** 设置中新增普通 / 困难人机；加强 A 小与 B 区烟闪火配合、失败路线恢复，修正 B 狗洞局部碰撞并补上人机观战准星。[更新说明与实机截图 →](docs/BOT-UPDATE.md)
...
| 命中有反馈 | 服务器确认击杀，显示击杀信息、本回合击杀数与扑克牌反馈；原版枪声、换弹声音和可见曳光。 |
...
首次基础下载约为桌面 **201.3 MiB**、手机 **133.0 MiB**。进度显示真实文件数量与下载量，之后准备纹理、模型和着色器，失败可重试。额外皮肤、探员和音乐盒在使用时下载。
