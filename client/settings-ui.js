...
export function mountSettings({controls,crosshair,getSettings,onSettings}) {
  ...
  return {element:modal,open(){returnFocus=document.activeElement;controls.clear();modal.hidden=false;select('#close-settings').focus();},close};
}
