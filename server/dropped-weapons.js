...
export class DroppedWeapons {
  ...
  drop(player,item){
    ...
    const dropped={id:`drop_${++this.serial}`,...item,x:origin.x+dir.x*offset,y:origin.y,z:origin.z+dir.z*offset,yaw:player.yaw||0,vx:dir.x*1.8,vy:1.1,vz:dir.z*1.8,expiresAt:this.clock()+this.lifetimeSeconds*1000};
